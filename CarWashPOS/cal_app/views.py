...
from core.selectors import get_all_locations_by_user, get_location_by_id
from .selectors import get_cal_event_by_id, get_cal_events_for_month
from .services import calendar_event_create
...
class CalendarView(LoginRequiredMixin, View):
    def get(self, request):
        ...
        selected_location = (
            get_location_by_id(location_id=selected_location_id)
            if selected_location_id
            else locations.first()
        )

        events = (
            get_cal_events_for_month(
                location=selected_location, year=selected_year, month=selected_month
            )
        ...
        return render(request, "cal_app/calendar.html", context)
